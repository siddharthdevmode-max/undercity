  ...
  return (
    <section className="stats-section" ref={sectionRef}>
      <div className="stats-inner">
        <span className="stats-eyebrow">REAL TIME ACTIVITY</span>
        ...
        <div className="stats-grid">
          <StatCard
            value={s.onlineNow}
            label="ONLINE NOW"
            sublabel="Players currently active"
            start={visible}
            delay={0}
          />
          <StatCard
